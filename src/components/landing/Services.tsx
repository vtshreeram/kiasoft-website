...
const services = [
  {
    title: "AI-Augmented EHR",
    description: "Intelligent Prakriti, Vikriti & Nadi analysis modules that learn from clinical patterns.",
    icon: Stethoscope,
    className: "md:col-span-2 md:row-span-2 bg-green-50 border-green-100",
    iconColor: "text-green-600 bg-white",
  },
  {
    title: "Smart Panchakarma",
    description: "AI-automated protocol tracking that adapts based on patient progress.",
    icon: Activity,
  ...
  },
  {
    ...
    description: "AI-driven raw herb & batch tracking with automated replenishment.",
    icon: Leaf,
    className: "md:col-span-1 md:row-span-1 bg-white border-slate-100",
  ...
  },
  {
    ...
    description: "AI monitors and ensures Ayush Ministry standards across every workflow.",
    icon: Shield,
    className: "md:col-span-1 md:row-span-1 bg-white border-slate-100",
  ...
  },
  {
    ...
    description: "Advanced AI models tracking treatment efficacy and operational throughput.",
    icon: Database,
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative p-8 rounded-3xl border flex flex-col justify-between overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 cursor-pointer ${service.className}`}
              >
